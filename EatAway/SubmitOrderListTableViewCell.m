//
//  SubmitOrderListTableViewCell.m
//  EatAway
//
...
@interface SubmitOrderListTableViewCell ()
{
    UIView *viewBG;
    UIImageView *IVHead;
    UILabel *labelTitle;
...
@implementation SubmitOrderListTableViewCell
...
-(void)setContentWithHeadImage:(NSString *)strImage title:(NSString *)strTitle listDic:(NSDictionary *)arrFoodList totalPrice:(NSString *)strTotalPrice
{
    ...
    labelFeeNum.frame = CGRectMake(WINDOWWIDTH - 10 - 10 - 10 - 100, 50 + arrFoodList.count * 70 + 5, 100, 15);
